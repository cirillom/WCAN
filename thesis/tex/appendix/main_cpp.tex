...
\path{transmitter/main/main.cpp}\footnote{Disponível em: \url{https://github.com/cirillom/WCAN/blob/main/transmitter/main/main.cpp}.}. O objetivo é mostrar a estrutura de inicialização, o recebimento da configuração de \emph{boot} por UART e a seleção do papel da placa na campanha experimental, evitando que o apêndice reproduza o arquivo completo.
