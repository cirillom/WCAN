...
\hline
Item comparado & Massa típica & Observação \\
\hline
...
\begin{tabularx}{\textheight}{>{\raggedright\arraybackslash}p{0.18\textheight}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X}
\hline
