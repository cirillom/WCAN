...
Foram implementadas duas variantes de transporte, broadcast e multicast, ligadas em
tempo de compilação. As duas usam o mesmo formato de pacote e a mesma aplicação de
teste, o que permitiu comparar estratégias de endereçamento e confiabilidade sem
alterar a instrumentação. O papel de cada placa, sensor, receptor ou nó ocioso, é
definido no boot por uma linha enviada pela serial, junto com frequência de geração,
CAN ID base, quantidade de IDs e valor de \texttt{linger\_ms}.
