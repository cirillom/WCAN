...
massa, volume, tempo de manutenção e pontos de falha.
...
\begin{itemize}
    ...
    \item implementar o WCAN como camada de comunicação sobre ESP-NOW, preservando
    o maior número possível de características úteis de uma rede CAN para
    aquisição de dados;
    \item desenvolver e comparar variantes de transporte adequadas a essa ponte sem
    fio;
