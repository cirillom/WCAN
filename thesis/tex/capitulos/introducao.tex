...
um núcleo comum de transmissão e recepção, suporte a agrupamento temporal de
amostras, filtragem por identificador e duas políticas de transporte. Como suporte
...
sobre 679 execuções, ou 66,7\%. O resultado mais representativo aparece na suíte
\texttt{multiple}: o multicast aprovou 90 de 90 execuções com múltiplos CAN IDs
por sensor, enquanto o broadcast aprovou 34 de 90. O agrupamento temporal também
foi determinante: as suítes com \texttt{linger\_ms = 100} somaram 415 aprovações
em 499 execuções, enquanto a suíte \texttt{real\_time}, sem agrupamento, somou 38
em 180. Esses resultados indicam que o WCAN é viável em bancada para aquisição de
dados quando usado dentro dos limites observados, especialmente com agrupamento de
amostras.
